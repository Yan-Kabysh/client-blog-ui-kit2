...
var Heading = function (_a) {
    ...
    return React__default.createElement(type, { className: "".concat(headingClass, " ").concat(className) }, children);
};
...
export { Body, Button, Display, Footer, Header, Heading, Icon, Label };
