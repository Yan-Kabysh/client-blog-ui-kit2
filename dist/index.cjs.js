...
var Button = function (_a) {
    var onClick = _a.onClick, label = _a.label, _b = _a.variant, variant = _b === void 0 ? 'primary' : _b, _c = _a.size, size = _c === void 0 ? 'medium' : _c;
    return (jsxRuntimeExports.jsx("button", { className: "button ".concat(variant, " ").concat(size), onClick: onClick, children: label }));
};

var Body = function (_a) {
    var children = _a.children, _b = _a.type, type = _b === void 0 ? 1 : _b, _c = _a.className, className = _c === void 0 ? '' : _c;
    return (jsxRuntimeExports.jsx("span", { className: "body".concat(type, " ").concat(className), children: children }));
};

var Display = function (_a) {
    var children = _a.children;
    return (jsxRuntimeExports.jsx("span", { className: "display", children: children }));
};

var Heading = function (_a) {
    var type = _a.type, children = _a.children, _b = _a.className, className = _b === void 0 ? '' : _b;
    var headingClass = type;
    return React.createElement(type, { className: "".concat(headingClass, " ").concat(className) }, children);
};
...
console.log('config', SvgFacebook);
var icons$1 = {
...
var Icon = function (_a) {
    var name = _a.name, _b = _a.size, size = _b === void 0 ? 16 : _b, _c = _a.fill, fill = _c === void 0 ? 'currentColor' : _c;
    var IconComponent = icons$1[name];
    console.log('icons:', icons$1); // Проверьте, что объект icons корректен
    ...
    return jsxRuntimeExports.jsx(IconComponent, { width: size, height: size, fill: fill });
};
...
var Footer = function (_a) {
    var title = _a.title, links = _a.links, mainText = _a.mainText, btnLabel = _a.btnLabel, btnClick = _a.btnClick, email = _a.email, address = _a.address;
    return (jsxRuntimeExports.jsxs("div", { className: "footer-wrapper", children: [jsxRuntimeExports.jsxs("div", { className: "footer-header", children: [jsxRuntimeExports.jsx(Heading, { className: "title", type: 'h4', children: title }), jsxRuntimeExports.jsx("div", { className: "links", children: Object.entries(links).map(function (_a) {
                            var title = _a[0], url = _a[1];
                            return (jsxRuntimeExports.jsx("a", { className: "link-item", href: url, children: title }, url));
                        }) })] }), jsxRuntimeExports.jsxs("div", { className: "footer-main", children: [jsxRuntimeExports.jsx(Heading, { className: "footer-main-text", type: 'h2', children: mainText }), jsxRuntimeExports.jsxs("div", { children: [jsxRuntimeExports.jsx("input", { type: "email" }), jsxRuntimeExports.jsx(Button, { label: btnLabel, onClick: btnClick })] })] }), jsxRuntimeExports.jsxs("div", { className: "footer-footer", children: [jsxRuntimeExports.jsxs("div", { className: "contact", children: [jsxRuntimeExports.jsx(Body, { type: 1, children: address }), jsxRuntimeExports.jsx(Body, { type: 1, children: email })] }), jsxRuntimeExports.jsx("div", { className: "icons", children: icons.map(function (item) { return jsxRuntimeExports.jsx(Icon, { fill: '#6D6E76', name: item }); }) })] })] }));
};

var Header = function (_a) {
    var title = _a.title, links = _a.links, btnLabel = _a.btnLabel, btnClick = _a.btnClick;
    return (jsxRuntimeExports.jsxs("div", { className: "header-wrapper", children: [jsxRuntimeExports.jsx(Heading, { className: "title", type: 'h4', children: title }), jsxRuntimeExports.jsxs("div", { className: "links", children: [Object.entries(links).map(function (_a) {
                        var title = _a[0], url = _a[1];
                        return (jsxRuntimeExports.jsx("a", { className: "link-item", href: url, children: title }, url));
                    }), jsxRuntimeExports.jsx(Button, { variant: "secondary", label: btnLabel, onClick: btnClick })] })] }));
};

var Label = function (_a) {
    var children = _a.children;
    return (jsxRuntimeExports.jsx("span", { className: "label", children: children }));
};
